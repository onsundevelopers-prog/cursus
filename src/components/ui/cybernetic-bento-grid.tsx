                ...
                <div className="flex flex-col justify-between h-full">
                  <div>
                    <div className="flex items-center gap-2 mb-3">
                      <feature.icon className="w-5 h-5 text-gray-400 group-hover:text-gray-600 transition-colors" />
                    </div>
                  ...
                  <div className="text-xs text-gray-400 group-hover:text-gray-600 transition-colors mt-4">
                    Explore →
                  </div>
                </div>
              </Link>
